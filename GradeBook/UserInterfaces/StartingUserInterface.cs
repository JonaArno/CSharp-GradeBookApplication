...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (type == "standard") gradeBook = new StandardGradeBook(name,weighted);
            else if (type == "ranked") gradeBook = new RankedGradeBook(name,weighted);
            else { Console.WriteLine($"{type} is not a supported type of gradebook, please try again");
                return;
            }
